...
exports.DataChatServiceClient = void 0;
 ...
 */
const gapicConfig = require("./data_chat_service_client_config.json");
...
class DataChatServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.geminidataanalytics.v1alpha.DataChatService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.dataChatServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.geminidataanalytics.v1alpha.DataChatService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.geminidataanalytics.v1alpha.DataChatService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const dataChatServiceStubMethods = ['chat', 'createConversation', 'deleteConversation', 'getConversation', 'listConversations', 'listMessages'];
        for (const methodName of dataChatServiceStubMethods) {
            const callPromise = this.dataChatServiceStub.then(stub => (...args) => {
                if (this._terminated) {
...
exports.DataChatServiceClient = DataChatServiceClient;
//# sourceMappingURL=data_chat_service_client.js.map