...
class DataAgentServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createDataAgentResponse = protoFilesRoot.lookup('.google.cloud.geminidataanalytics.v1alpha.DataAgent');
        const createDataAgentMetadata = protoFilesRoot.lookup('.google.cloud.geminidataanalytics.v1alpha.OperationMetadata');
        const updateDataAgentResponse = protoFilesRoot.lookup('.google.cloud.geminidataanalytics.v1alpha.DataAgent');
        const updateDataAgentMetadata = protoFilesRoot.lookup('.google.cloud.geminidataanalytics.v1alpha.OperationMetadata');
        const deleteDataAgentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteDataAgentMetadata = protoFilesRoot.lookup('.google.cloud.geminidataanalytics.v1alpha.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.geminidataanalytics.v1alpha.DataAgentService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.dataAgentServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.geminidataanalytics.v1alpha.DataAgentService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.geminidataanalytics.v1alpha.DataAgentService, this._opts, this._providedCustomServicePath);
