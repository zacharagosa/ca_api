...
exports.DataAgentServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/data_agent_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./data_agent_service_client_config.json");
...
class DataAgentServiceClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('geminidataanalytics');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            conversationPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/conversations/{conversation}'),
            dataAgentPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/dataAgents/{data_agent}'),
        ...
        this.descriptors.page = {
            listDataAgents: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'dataAgents'),
            listAccessibleDataAgents: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'dataAgents')
        };
        ...
        const createDataAgentResponse = protoFilesRoot.lookup('.google.cloud.geminidataanalytics.v1beta.DataAgent');
        const createDataAgentMetadata = protoFilesRoot.lookup('.google.cloud.geminidataanalytics.v1beta.OperationMetadata');
        const updateDataAgentResponse = protoFilesRoot.lookup('.google.cloud.geminidataanalytics.v1beta.DataAgent');
        const updateDataAgentMetadata = protoFilesRoot.lookup('.google.cloud.geminidataanalytics.v1beta.OperationMetadata');
        const deleteDataAgentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteDataAgentMetadata = protoFilesRoot.lookup('.google.cloud.geminidataanalytics.v1beta.OperationMetadata');
        this.descriptors.longrunning = {
            createDataAgent: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createDataAgentResponse.decode.bind(createDataAgentResponse), createDataAgentMetadata.decode.bind(createDataAgentMetadata)),
            updateDataAgent: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateDataAgentResponse.decode.bind(updateDataAgentResponse), updateDataAgentMetadata.decode.bind(updateDataAgentMetadata)),
            deleteDataAgent: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteDataAgentResponse.decode.bind(deleteDataAgentResponse), deleteDataAgentMetadata.decode.bind(deleteDataAgentMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.geminidataanalytics.v1beta.DataAgentService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.dataAgentServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.geminidataanalytics.v1beta.DataAgentService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.geminidataanalytics.v1beta.DataAgentService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const dataAgentServiceStubMethods = ['listDataAgents', 'listAccessibleDataAgents', 'getDataAgent', 'createDataAgent', 'updateDataAgent', 'deleteDataAgent', 'getIamPolicy', 'setIamPolicy'];
        for (const methodName of dataAgentServiceStubMethods) {
            const callPromise = this.dataAgentServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getDataAgent(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    createDataAgent(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     * @example <caption>include:samples/generated/v1beta/data_agent_service.create_data_agent.js</caption>
     * region_tag:geminidataanalytics_v1beta_generated_DataAgentService_CreateDataAgent_async
     */
    async checkCreateDataAgentProgress(name) {
    ...
    updateDataAgent(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta/data_agent_service.update_data_agent.js</caption>
     * region_tag:geminidataanalytics_v1beta_generated_DataAgentService_UpdateDataAgent_async
     */
    async checkUpdateDataAgentProgress(name) {
    ...
    deleteDataAgent(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta/data_agent_service.delete_data_agent.js</caption>
     * region_tag:geminidataanalytics_v1beta_generated_DataAgentService_DeleteDataAgent_async
     */
    async checkDeleteDataAgentProgress(name) {
    ...
    listDataAgents(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.geminidataanalytics.v1beta.DataAgent|DataAgent} on 'data' event.
    ...
    listDataAgentsStream(request, options) {
        ...
        return this.descriptors.page.listDataAgents.createStream(this.innerApiCalls.listDataAgents, request, callSettings);
    }
    /**
     ...
     *   {@link protos.google.cloud.geminidataanalytics.v1beta.DataAgent|DataAgent}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta/data_agent_service.list_data_agents.js</caption>
     * region_tag:geminidataanalytics_v1beta_generated_DataAgentService_ListDataAgents_async
     */
    listDataAgentsAsync(request, options) {
        ...
        return this.descriptors.page.listDataAgents.asyncIterate(this.innerApiCalls['listDataAgents'], request, callSettings);
    }
    listAccessibleDataAgents(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   Optional. If true, the list results will include soft-deleted DataAgents.
     *   Defaults to false.
     * @param {google.cloud.geminidataanalytics.v1beta.ListAccessibleDataAgentsRequest.CreatorFilter} [request.creatorFilter]
    ...
    listAccessibleDataAgentsStream(request, options) {
        ...
        return this.descriptors.page.listAccessibleDataAgents.createStream(this.innerApiCalls.listAccessibleDataAgents, request, callSettings);
    }
    /**
     ...
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta/data_agent_service.list_accessible_data_agents.js</caption>
     * region_tag:geminidataanalytics_v1beta_generated_DataAgentService_ListAccessibleDataAgents_async
     */
    listAccessibleDataAgentsAsync(request, options) {
        ...
        return this.descriptors.page.listAccessibleDataAgents.asyncIterate(this.innerApiCalls['listAccessibleDataAgents'], request, callSettings);
    }
    /**
...
exports.DataAgentServiceClient = DataAgentServiceClient;
//# sourceMappingURL=data_agent_service_client.js.map